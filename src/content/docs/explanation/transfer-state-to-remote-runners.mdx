...
If you want to understand exactly which state Endform will transfer to the remote runners, you can use the `--debug` flag to show the files and environment variables that are transferred: `endform test --debug`.
...
- **Environment Variables** - `environmentVariables` in your Endform config
- **Files** - `additionalFiles` in your Endform config

For more information on these options, see the [Endform config reference](/docs/reference/endform-config-ts).
