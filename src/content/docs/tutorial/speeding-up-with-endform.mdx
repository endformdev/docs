...
<Aside>
  To start from this step, check out the [`stage-2-generated-tests`
  branch](https://github.com/endformdev/playwright-tutorial/tree/stage-2-generated-tests)
  of the [tutorial
...
<Image
  src={TestTimeChart}
  alt="A chart of the test time for different repeat counts"
  width={800}
/>
