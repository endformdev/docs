...
<Tabs>
  <TabItem label="Linux/macOS">
    ```bash
    touch tests/setup.spec.ts tests/teardown.spec.ts
    ```
  </TabItem>
  <TabItem label="Windows (PowerShell)">
    ```powershell
    New-Item -ItemType File -Path tests/setup.spec.ts, tests/teardown.spec.ts
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Windows (PowerShell)">
    ```powershell
    New-Item -ItemType File -Path global-setup.ts, global-teardown.ts
    ```
  </TabItem>
</Tabs>
