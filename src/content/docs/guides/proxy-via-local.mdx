...
1. ### Configure which traffic to proxy.
   ...
   You can configure both at the same time if needed. You can read more about `proxyNetworkHosts` and `proxyNetworkPorts` in the [endform config reference](/docs/reference/endform-config#proxynetworkhosts).
